...
<body>
	<h1>ADD</h1>
	<form action="/RandomGroupApi/person" method="post">
	...
	function getDelete()
	{
		...
		theForm.method = "post"; 
		theForm.action = "/RandomGroupApi/person/"+delName.value;
		theForm.submit();
	}
	</script>
	
	<h1>GET LIST</h1>
	<form action="/RandomGroupApi/person" method="get">
	...
	function getGroup()
	{
		...
		theForm.method = "get"; 
		theForm.action = "/RandomGroupApi/random/"+groupSize.value+"/"+limitSize.value;
		theForm.submit();
	}
	</script>
